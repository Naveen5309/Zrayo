            ...
            Column(
              ...
              children: [
                ...
                GridView.builder(
                  ...
                  itemCount: (myPropertyState is MyPropertyLoaded)
                      ? myPropertyState.images.length + 1
                      : 1,
                  ...
                  itemBuilder: (context, index) {
                    if (myPropertyState is MyPropertyLoaded &&
                        index < myPropertyState.images.length) {
                      final image = myPropertyState.images[index];
                      return Stack(
                        children: [

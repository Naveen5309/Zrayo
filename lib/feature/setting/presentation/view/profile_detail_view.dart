          ...
          Row(
            children: [
              Column(
                ...
                children: [
                  AppText(
                      text: AppString.completeAddress.tr(),
                      textSize: 14.sp,
                      color: AppColor.black111111,
                      fontFamily: AppFonts.satoshiBlack),
                  yHeight(context.height * 0.01),
